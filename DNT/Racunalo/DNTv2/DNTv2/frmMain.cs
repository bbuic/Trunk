...
namespace DNTv2
{
    public partial class frmMain : Form
    {
        ...
        private void ZatvoriVrata()
        {
            ...
            //Ispisi("Molimo da zatvorite vrata...");            
                    ...
                    switch (SerialPortElektronika.ReadByte())
                    {
                        case 0x20:
                            ...
                            if (ObjectFactory.KarticaDataService.PostojiBrojKartice(kartica, true))
                            {
                                ...
                                _lcd.Ispisi("   OTORITE VRATA      Ubacujte vrecice");
                            }
                            break;
                        ...
                        case 0x21: //vrata otvorena
                            TimerZasunStop();
                            TimerVrataOtvorenaStart();
                            _lcd.Ispisi("Dozvoljeno ubacivatiUbaceno vrecica = 0");
                            break;                            
                        case 0x23: //ubacaj vrecica
                            ...
                            _lcd.Ispisi("Dozvoljeno ubacivatiUbaceno vrecica = " + _transakcija.BrojVrecica + "");
                        ...
                        case 0x22: //vrata zatorena
                            ...
                            _lcd.Ispisi("HVALA NA POVJERENJU!");
                            Thread.Sleep(3000);
                            _lcd.UvodnaPoruka();
